...
def load_keyword_sentences(file_specification):
    if file_specification=='MNI_sentences_includesWordBoundaries':
        file_list=glob.glob('sentence_data/MNI_sentences_Neuroimage*_includesWordBoundaries.p')
        keyword_sentences=[]
...
def get_above_n_occurances(wordfreq,N):
    ...
    sort_words_above_n_occurances=sorted(words_above_n_occurances) # sort list alphabetically
